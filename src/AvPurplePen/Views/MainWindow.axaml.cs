    ...
    public partial class MainWindow : Window
    {
        ...
        private void SetupMacOSNativeMenu()
        {
            try
            {
                ...
                // Build native menu structure from ViewModel commands
            ...
            {
                // If native menu setup fails, just continue with the XAML menu
            }
        }
        ...
        private void MainWindow_DataContextChanged(object? sender, EventArgs e)
        {
            ...
            if (_mainViewModel != null) {
                ...
                // On macOS, set up native menu bar when ViewModel is available
